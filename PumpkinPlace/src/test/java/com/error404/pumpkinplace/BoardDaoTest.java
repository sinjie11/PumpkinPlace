...
//		Board board5= new Board(2, 5, "Test", "Content", "admin", new Date(), null, null, 0, 0, 0);
//		Board board6= new Board(3, 6, "Test", "Content", "admin", new Date(), null, null, 0, 0, 0);
//		Board board7= new Board(1, 7, "Test", "Content", "admin", new Date(), null, null, 0, 0, 0);
//		Board board8= new Board(1, 8, "Test", "Content", "admin", new Date(), null, null, 0, 0, 0);
