								...
								<div id="en_title">
									<p>
										<label for="event_공연 이름 :">공연 제목: <input
											...
											value=" ${showboard.sb_title}" required />
										</label>
									</p>
								</div>
	        ...
	        scrollbar: true
				...
				$("#country ? option[value='"${showboard.sb_city}"']").attr("selected","true");
								...
								<div id="en_price">
									...
									<p>
										<fmt:formatNumber value="${showboard.sb_price}"
											pattern="#,### 원" var="price">
										</fmt:formatNumber>
										<label for="sb_price"> 가격:<input id="event_door_price"
											name="sb_price" type="number" value="${showboard.sb_price}"
								...
								<div id="en_description">
									...
									<p>
										<textarea name="description" rows="5" cols="50"
											name="sb_content" id="showinserttext" required>${showboard.sb_content}</textarea>
									</p>
									<br />
								</div>
								<br /> <br />
