...
<body>
	...
	<form action="update">
		...
		<input type="number" name="b_no" value="${board.b_no}" readonly /> <br />
		<input type="text" value="${board.b_title}" readonly /> <br />
		<textarea rows="5" cols="50" readonly>${board.b_content}</textarea>
		<br /> <input type="text" value="${board.b_id}" readonly /> <br />
		<fmt:formatDate value="${board.b_regdate}"
			pattern="yyyy/MM/dd HH:mm:ss" var="b_regdate" />
		<input type="text" value="${b_regdate}" readonly /> <br />
