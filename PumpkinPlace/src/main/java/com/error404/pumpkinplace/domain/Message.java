...
public class Message {
	...
	public Message(long msg_no, String mem_id, String msg_title, String msg_content, String msg_send,
			String msg_recieve, Date msg_regdate) {
		super();
		this.msg_no = msg_no;
		this.mem_id = mem_id;
